# Helper library for C/C++ code generation. Adapted from https://www.codeproject.com/Articles/571645/Really-simple-Cplusplus-code-generation-in-Python
...
class CodeFile:
    ...
    def format(self, text):
        while True:
            m = None#PLACEHOLDER.search(text)
            if m is None:
                return text
            s = None
    ...
    def line(self, number, file):
        self.write(self.format('#line ' + number + ' ' + file))
